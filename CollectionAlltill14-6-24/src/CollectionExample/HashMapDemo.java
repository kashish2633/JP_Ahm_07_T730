...
class HashMapDemo 
{
	public static void main(String args[]) 
	{
		...
		studentMap.put(10001,new Student(1,"Ami",78));
		studentMap.put(10005,new Student(2,"Keya",84));
		studentMap.put(10006,new Student(3,"Reeva",81));
		studentMap.put(10003,new Student(5,"Sarth",72));
		studentMap.put(10004,new Student(4,"Hriday",78));
